...
//        mtlVertexDescriptor2.attributes[VertexAttribute.position.rawValue].format = MTLVertexFormat.float4
//        mtlVertexDescriptor2.attributes[VertexAttribute.position.rawValue].offset = 0
//        mtlVertexDescriptor2.attributes[VertexAttribute.position.rawValue].bufferIndex = BufferIndex.meshPositions.rawValue
//
//        mtlVertexDescriptor2.attributes[VertexAttribute.color.rawValue].format = MTLVertexFormat.float4
//        mtlVertexDescriptor2.attributes[VertexAttribute.color.rawValue].offset = 0
//        mtlVertexDescriptor2.attributes[VertexAttribute.color.rawValue].bufferIndex = BufferIndex.uniforms.rawValue
//
//        mtlVertexDescriptor2.layouts[BufferIndex.meshPositions.rawValue].stride = 16
//        mtlVertexDescriptor2.layouts[BufferIndex.meshPositions.rawValue].stepRate = 1
//        mtlVertexDescriptor2.layouts[BufferIndex.meshPositions.rawValue].stepFunction = MTLVertexStepFunction.perVertex
        
//        mtlVertexDescriptor2.layouts[BufferIndex.uniforms.rawValue].stride = 16
//        mtlVertexDescriptor2.layouts[BufferIndex.uniforms.rawValue].stepRate = 1
//        mtlVertexDescriptor2.layouts[BufferIndex.uniforms.rawValue].stepFunction = MTLVertexStepFunction.perVertex
/*
       // let mtlVertexDescriptor = Renderer.buildMetalVertexDescriptor()
        
        do {
            pipelineState = try Renderer.buildRenderPipelineWithDevice(device: metalKitView.device!,
